  ...
  <div className="bookCover">
    ...
    <div className="bookCover__right">
      ...
      <p className="bookCover__right__content">
        ...
        The story of a reluctant hero navigating the trauma of a life-altering
        diagnosis. After going through a long-term, debilitating stage of grief,
        he emerges to find life worth living and enjoying again.
      ...
      <button className="bookCover__right__button">Read More</button>
    </div>
  </div>
)
